...
data_path4 = r"C:\Users\44771\Desktop\Data\2212\2212_1308"
data_file_name4 = os.path.split(data_path4)[1]

polarisation_data4 = np.load(f'{data_path4}/polarisation_data.npy', allow_pickle=True)
polarisation_averages4 = np.load(f'{data_path4}/polarisation_averages.npy', allow_pickle=True)
rotation_averages4 = np.load(f'{data_path4}/rotation_averages.npy', allow_pickle=True)

ral_array4 = [sub_array[-2] for sub_array in polarisation_data4[0][:,0][:,1]]
rat_array4 = [sub_array[-1] for sub_array in polarisation_data4[0][:,0][:,1]]

x4 = np.asarray(ral_array4)
y4 = np.asarray(rat_array4) 
X4 = x4 - 1 
Y4 = y4 - x4[0]
O_r4 = rotation_averages4
O_p4 = polarisation_averages4
print(O_p4)
...
for i in range(2):
    ...
    ax.plot_wireframe(X4, np.tile(Y4, (11,1)).T, O_i4[i], rstride=1, cstride=1, color=colour[i])
    ...
    if save_plots:
        ...
        plt.savefig(f'{plot_dir}/{label[i]}_combined', dpi=300, bbox_inches=None)#
